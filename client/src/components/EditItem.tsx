...
import { EditItemFunction } from '../apiService';
import { ItemInterface } from '../interfaces/item';

const Item: React.FC<ItemInterface> = ({ _id, img, title, desc, category, condition, price, size, user }) => {
    const [imageID, setImageId] = useState(_id);
    const [titleInput, setTitleInput] = useState(title);
    const [descInput, setDescInput] = useState(desc);
    const [priceInput, setPriceInput] = useState(price);
    const [condInput, setCondInput] = useState(condition);
